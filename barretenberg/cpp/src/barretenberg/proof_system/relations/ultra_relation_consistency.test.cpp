...
struct InputElements {
    ...
    CONST_COMPATIBLE_GETTER(FF, q_c, std::get<0>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_l, std::get<1>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_r, std::get<2>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_o, std::get<3>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_4, std::get<4>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_m, std::get<5>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_arith, std::get<6>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_sort, std::get<7>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_elliptic, std::get<8>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_aux, std::get<9>(_data))
    CONST_COMPATIBLE_GETTER(FF, q_lookup, std::get<10>(_data))
    CONST_COMPATIBLE_GETTER(FF, sigma_1, std::get<11>(_data))
    CONST_COMPATIBLE_GETTER(FF, sigma_2, std::get<12>(_data))
    CONST_COMPATIBLE_GETTER(FF, sigma_3, std::get<13>(_data))
    CONST_COMPATIBLE_GETTER(FF, sigma_4, std::get<14>(_data))
    CONST_COMPATIBLE_GETTER(FF, id_1, std::get<15>(_data))
    CONST_COMPATIBLE_GETTER(FF, id_2, std::get<16>(_data))
    CONST_COMPATIBLE_GETTER(FF, id_3, std::get<17>(_data))
    CONST_COMPATIBLE_GETTER(FF, id_4, std::get<18>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_1, std::get<19>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_2, std::get<20>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_3, std::get<21>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_4, std::get<22>(_data))
    CONST_COMPATIBLE_GETTER(FF, lagrange_first, std::get<23>(_data))
    CONST_COMPATIBLE_GETTER(FF, lagrange_last, std::get<24>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_l, std::get<25>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_r, std::get<26>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_o, std::get<27>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_4, std::get<28>(_data))
    CONST_COMPATIBLE_GETTER(FF, sorted_accum, std::get<29>(_data))
    CONST_COMPATIBLE_GETTER(FF, z_perm, std::get<30>(_data))
    CONST_COMPATIBLE_GETTER(FF, z_lookup, std::get<31>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_1_shift, std::get<32>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_2_shift, std::get<33>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_3_shift, std::get<34>(_data))
    CONST_COMPATIBLE_GETTER(FF, table_4_shift, std::get<35>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_l_shift, std::get<36>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_r_shift, std::get<37>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_o_shift, std::get<38>(_data))
    CONST_COMPATIBLE_GETTER(FF, w_4_shift, std::get<39>(_data))
    CONST_COMPATIBLE_GETTER(FF, sorted_accum_shift, std::get<40>(_data))
    CONST_COMPATIBLE_GETTER(FF, z_perm_shift, std::get<41>(_data))
    CONST_COMPATIBLE_GETTER(FF, z_lookup_shift, std::get<42>(_data))
};
