...
template <typename BuilderType> class UltraRecursive_ {
  ...
  private:
    ...
    class AllEntities : public AllEntities_<DataType, HandleType, NUM_ALL_ENTITIES> {
      public:
        DataType& q_c() { return std::get<0>(this->_data); }
        DataType& q_l() { return std::get<1>(this->_data); }
        DataType& q_r() { return std::get<2>(this->_data); }
        DataType& q_o() { return std::get<3>(this->_data); }
        DataType& q_4() { return std::get<4>(this->_data); }
        DataType& q_m() { return std::get<5>(this->_data); }
        DataType& q_arith() { return std::get<6>(this->_data); }
        DataType& q_sort() { return std::get<7>(this->_data); }
        DataType& q_elliptic() { return std::get<8>(this->_data); }
        DataType& q_aux() { return std::get<9>(this->_data); }
        ...
        DataType& lagrange_first() { return std::get<23>(this->_data); }
        DataType& lagrange_last() { return std::get<24>(this->_data); }
        DataType& w_l() { return std::get<25>(this->_data); }
        DataType& w_r() { return std::get<26>(this->_data); }
        DataType& w_o() { return std::get<27>(this->_data); }
        DataType& w_4() { return std::get<28>(this->_data); }
        DataType& sorted_accum() { return std::get<29>(this->_data); }
        DataType& z_perm() { return std::get<30>(this->_data); }
        DataType& z_lookup() { return std::get<31>(this->_data); }
        DataType& table_1_shift() { return std::get<32>(this->_data); }
        DataType& table_2_shift() { return std::get<33>(this->_data); }
        DataType& table_3_shift() { return std::get<34>(this->_data); }
        DataType& table_4_shift() { return std::get<35>(this->_data); }
        DataType& w_l_shift() { return std::get<36>(this->_data); }
        DataType& w_r_shift() { return std::get<37>(this->_data); }
        DataType& w_o_shift() { return std::get<38>(this->_data); }
        DataType& w_4_shift() { return std::get<39>(this->_data); }
        DataType& sorted_accum_shift() { return std::get<40>(this->_data); }
        DataType& z_perm_shift() { return std::get<41>(this->_data); }
        DataType& z_lookup_shift() { return std::get<42>(this->_data); }
