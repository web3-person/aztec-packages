...
template <size_t mini_circuit_size> class GoblinTranslator_ {
  ...
  private:
     ...
     */
    template <typename DataType, typename HandleType> class AllEntities {
      public:
        ...
        [[nodiscard]] size_t size() const { return named_array_size(*this); }
        inline Element& operator[](size_t idx) { return named_array_span(*this)[idx]; }
        /**
         * @brief Get the polynomials that are concatenated for the permutation relation
         *
         * @return std::vector<std::vector<HandleType>>
