...
#include "barretenberg/honk/flavor/ultra_parts.hpp"
  ...
  private:
    ...
    class AllEntities : public AllEntities_<DataType, HandleType, NUM_ALL_ENTITIES> {
      public:
        ...
        CONST_COMPATIBLE_GETTER(DataType, lagrange_first, std::get<23>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, lagrange_last, std::get<24>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_l, std::get<25>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_r, std::get<26>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_o, std::get<27>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_4, std::get<28>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, sorted_accum, std::get<29>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, z_perm, std::get<30>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, z_lookup, std::get<31>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, table_1_shift, std::get<32>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, table_2_shift, std::get<33>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, table_3_shift, std::get<34>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, table_4_shift, std::get<35>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_l_shift, std::get<36>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_r_shift, std::get<37>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_o_shift, std::get<38>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, w_4_shift, std::get<39>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, sorted_accum_shift, std::get<40>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, z_perm_shift, std::get<41>(this->_data))
        CONST_COMPATIBLE_GETTER(DataType, z_lookup_shift, std::get<42>(this->_data))
