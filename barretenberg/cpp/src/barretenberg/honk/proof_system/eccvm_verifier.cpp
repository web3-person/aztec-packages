...
template <typename Flavor> bool ECCVMVerifier_<Flavor>::verify_proof(const plonk::proof& proof)
{
    ...
    commitments.transcript_pc() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.transcript_pc());
    ...
    commitments.transcript_z1() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.transcript_z1());
    commitments.transcript_z2() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.transcript_z2());
    ...
    commitments.transcript_op() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.transcript_op());
    ...
    commitments.precompute_pc() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.precompute_pc());
    ...
    commitments.precompute_dx() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.precompute_dx());
    commitments.precompute_dy() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.precompute_dy());
    commitments.precompute_tx() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.precompute_tx());
    commitments.precompute_ty() =
        transcript.template receive_from_prover<Commitment>(commitment_labels.precompute_ty());
